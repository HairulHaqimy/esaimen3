...
public class Inventory {
	...
	private void initialize() {
		...
		lblCategory.setBounds(10, 81, 85, 24);
		...
		lblName.setBounds(10, 142, 85, 24);
		panel_1.add(lblName);
		lblName.setForeground(Color.DARK_GRAY);
		lblName.setFont(new Font("Times New Roman", Font.BOLD, 18));
		
		JLabel lblFlavour = new JLabel("Flavour");
		lblFlavour.setBounds(10, 208, 85, 24);
		...
		txtKeyInFlavour.setBounds(106, 204, 186, 34);
		...
		txtKeyInCategory.setBounds(106, 80, 186, 28);
		...
		txtKeyInMadeIn.setBounds(105, 275, 186, 34);
		...
		txtKeyInItemName.setBounds(105, 141, 186, 28);
		...
		table.setModel(new DefaultTableModel(
			new Object[][] {
				{ "Category", "Item Name", "Flavour", "Made In", "Price", "Quantity"},
			},
			new String[] {
				"Category", "Item Name", "Flavour", "Made In", "Price", "Quantity"
			}
